...
<template>
  <h1 class="text-center mt-5">Traveling for More Videos</h1>
    <v-row>
        <v-col cols="6">
            <v-img src="../images/cogon.jpg" class="mt-10 ml-16" width="800" height="400"></v-img>
        </v-col>
        <v-col cols="6">
            <h2 class="mt-12">Suwa ka leima</h2>
            <p class="mt-8" style="font-size: 20px;">
                ...
                alksdjlkasjdlkjaslkdjlkasjldkjaslkjdlkaslkjdjalsjldasjldjlaskjdlkjas
            </p>
        </v-col>
        <v-col cols="6" class="text-end">
            <h2 class="mt-15 ml-16 mr-12">Suwa ka leima</h2>
            <p class="mt-8 mr-12" style="font-size: 20px;">
                asdlkasdlkjasldkjaklsjdkjaslkdjalksjdkjlaslkdkljaskjldkjlas
                asdhasdhasdhasdhasdhasdhasdhasdhashdhasdhasdhhashdhasdhjasdjajs
                asdjasjdjasjdjasdasjdjasjdjajsdjasjdjasjdjasjdjasjjdajsdjajsd
